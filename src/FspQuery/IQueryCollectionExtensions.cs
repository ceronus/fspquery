...
public static class IQueryCollectionExtensions
{
    ...
    public static bool TryParse<T>(this IQueryCollection queries, T? result, out string? errorMessage)
    ...
    public static bool TryParse(this IQueryCollection queries, IFspQueryOptions options, out string? errorMessage)
    {
